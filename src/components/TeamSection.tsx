...
import { ArrowUpRight, Star, MessageCircle, Phone } from "lucide-react";
...
const doctors: Doctor[] = [
  ...
  },
  {
    ...
    department: "General Medicine",
    experience: "10 yrs",
    gradient: "linear-gradient(135deg, #2d4a7a 0%, #4a7ab5 100%)",
    initials: "NM",
    available: true,
    rating: 4.7,
    reviews: 198,
  ...
  {
    id: 5,
    name: "Dr. K.S. Manoj Kumar",
    role: "General & Lap. Surgeon",
    qualification: "MBBS, MS, FIAGES",
    department: "General Surgery",
    experience: "16 yrs",
    gradient: "linear-gradient(135deg, #1a3a6b 0%, #2a6bc0 100%)",
    initials: "MK",
    available: true,
    rating: 4.8,
    reviews: 334,
  },
  {
    ...
    department: "General Surgery",
    experience: "13 yrs",
    gradient: "linear-gradient(135deg, #1a5a3a 0%, #2a9a6a 100%)",
    initials: "SH",
    available: true,
    rating: 4.7,
    reviews: 215,
  },
  {
    ...
    name: "Dr. Geetha G.",
    role: "Gynaecologist",
    qualification: "MBBS, MS, OBG, PGD",
    department: "Gynaecology",
    experience: "15 yrs",
    gradient: "linear-gradient(135deg, #6b1a5a 0%, #b02a9a 100%)",
    initials: "GG",
    available: true,
    rating: 4.9,
    reviews: 389,
  },
  {
    ...
    department: "Urology",
    experience: "12 yrs",
    gradient: "linear-gradient(135deg, #3a1a6b 0%, #7a2ac0 100%)",
    initials: "RJ",
    available: true,
    rating: 4.8,
    reviews: 276,
  },
  {
    ...
    department: "Oncology",
    experience: "18 yrs",
    gradient: "linear-gradient(135deg, #5a1a1a 0%, #a83232 100%)",
    initials: "PD",
    available: true,
    rating: 4.9,
    reviews: 421,
  },
  {
    ...
    experience: "14 yrs",
    gradient: "linear-gradient(135deg, #1a4a5a 0%, #2a8aa0 100%)",
    initials: "KM",
    available: true,
    rating: 4.7,
    reviews: 188,
  ...
  {
    id: 11,
    name: "Dr. Manjunath B.R.",
    role: "Anaesthesiologist",
    qualification: "MBBS, MD",
    department: "Anaesthesiology",
    experience: "12 yrs",
    gradient: "linear-gradient(135deg, #1a3a5a 0%, #2a6a9a 100%)",
    initials: "MB",
    available: false,
    rating: 4.8,
    reviews: 203,
  },
  {
    ...
    experience: "10 yrs",
    gradient: "linear-gradient(135deg, #5a3a1a 0%, #a07030 100%)",
    initials: "SU",
    available: true,
    rating: 4.7,
    reviews: 162,
  ...
  },
  {
    ...
    department: "Pediatrics",
    experience: "9 yrs",
    gradient: "linear-gradient(135deg, #3a1a6b 0%, #6a3ac0 100%)",
    initials: "YW",
    available: false,
    rating: 4.7,
    reviews: 174,
    ...
    >
      ...
      <div style={{ padding: "16px 18px 0 18px", flex: 1 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "14px" }}>
          <StarRating rating={doctor.rating} />
          <span
            style={{ fontSize: "11px", color: "#8eaaa6", fontFamily: "'DM Sans', sans-serif" }}
          >
            ({doctor.reviews} reviews)
          </span>
        </div>
      ...
      {/* Divider */}
      <div style={{ height: "1px", background: "rgba(0,0,0,0.06)", margin: "0 18px" }} />
      ...
      >
        {doctor.phone ? (
          <div style={{ display: "flex", alignItems: "center", gap: "5px", minWidth: 0 }}>
            <Phone size={11} color="#6b8280" style={{ flexShrink: 0 }} />
            <span
              style={{
                fontSize: "10px",
                color: "#6b8280",
  ...
  return (
    <>
      <style>{`
        ...
        /* Mobile: slower on very small screens */
