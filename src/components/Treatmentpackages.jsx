...
const packages = [
  ...
  },
  {
    ...
    price: null,
    cta: "Enquire Now",
    features: ["Surgical consult", "Laparoscopic option", "2-day hospital stay", "Post-op follow-up"],
    icon: Scissors,
    maternity: false,
  },
  {
    ...
    price: null,
    cta: "Enquire Now",
    features: ["Urology consult", "Laser lithotripsy", "Stenting if needed", "Post-procedure care"],
    icon: Droplet,
    maternity: false,
  },
  {
